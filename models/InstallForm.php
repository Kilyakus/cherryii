...
{
    const RETURN_URL_KEY = 'cherryii_install_root_password';
    const ROOT_PASSWORD_KEY = 'cherryii_install_success_return';
    ...
    {
        return [
            'root_password' => Yii::t('cherryii/install', 'Root password'),
            'admin_email' => Yii::t('cherryii/install', 'Admin E-mail'),
            'robot_email' => Yii::t('cherryii/install', 'Robot E-mail')
        ];
    }
}