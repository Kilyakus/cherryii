<?php
use yii\db\Schema;
use yii\cherryii\models;

use yii\cherryii\modules\catalog;
use yii\cherryii\modules\shopcart;
use yii\cherryii\modules\article;
...
use yii\cherryii\modules\gallery;
use yii\cherryii\modules\guestbook\models\Guestbook;
use yii\cherryii\modules\news\models\News;
use yii\cherryii\modules\page\models\Page;
use yii\cherryii\modules\subscribe\models\Subscriber;
use yii\cherryii\modules\subscribe\models\History;
use yii\cherryii\modules\text\models\Text;
...
class m000000_000000_install extends \yii\db\Migration
{
    ...
    public function up()
    {
        ...
        //INSERT VERSION
        $this->delete(models\Setting::tableName(), ['name' => 'cherryii_version']);
