...
use yii\cherryii\assets\LiveAsset;
...
class AdminModule extends \yii\base\Module implements BootstrapInterface
{
    ...
    public function init()
    {
        ...
        define('LIVE_EDIT', !Yii::$app->user->isGuest && Yii::$app->session->get('cherryii_live_edit'));
    }


    public function bootstrap($app)
    {
        Yii::setAlias('cherryii', '@vendor/kilyakus/cherryii');
    ...
    public function renderToolbar()
    {
        ...
        echo $view->render('@cherryii/views/layouts/frontend-toolbar.php');
    }
    ...
    public function getInstalled()
    {
        if($this->_installed === null) {
            try {
                $this->_installed = Yii::$app->db->createCommand("SHOW TABLES LIKE 'cherryii_%'")->query()->count() > 0 ? true : false;
            } catch (\Exception $e) {
