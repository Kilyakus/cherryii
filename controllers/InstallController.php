...
use yii\cherryii\helpers\WebConsole;
use yii\cherryii\models\InstallForm;
...
class InstallController extends \yii\web\Controller
{
    ...
    {
        Yii::$app->i18n->translations['cherryii/install'] = [
            'class' => 'yii\i18n\PhpMessageSource',
            'sourceLanguage' => 'en-US',
            'basePath' => '@cherryii/messages',
            'fileMap' => [
                'cherryii/install' => 'install.php',
            ]
        ];
    }
    ...
    private function insertSettings($installForm)
    {
        ...
        $db->createCommand()->insert(Setting::tableName(), [
            ...
            'title' => Yii::t('cherryii/install', 'ReCaptcha key'),
        ...
        $db->createCommand()->insert(Setting::tableName(), [
            'name' => 'root_password',
            'value' => $root_password,
            'title' => Yii::t('cherryii/install', 'Root password'),
            'visibility' => Setting::VISIBLE_ROOT
        ])->execute();
        ...
        $db->createCommand()->insert(Setting::tableName(), [
            'name' => 'auth_time',
            'value' => 86400,
            'title' => Yii::t('cherryii/install', 'Auth time'),
            'visibility' => Setting::VISIBLE_ROOT
        ])->execute();
        ...
        $db->createCommand()->insert(Setting::tableName(), [
            ...
            'title' => Yii::t('cherryii/install', 'Robot E-mail'),
            'visibility' => Setting::VISIBLE_ROOT
        ])->execute();
        ...
        $db->createCommand()->insert(Setting::tableName(), [
            ...
            'title' => Yii::t('cherryii/install', 'Admin E-mail'),
        ...
        $db->createCommand()->insert(Setting::tableName(), [
            ...
            'title' => Yii::t('cherryii/install', 'ReCaptcha secret'),
            'visibility' => Setting::VISIBLE_ROOT
        ])->execute();
        ...
        $db->createCommand()->insert(Setting::tableName(), [
            ...
            'value' => 'top',
            'title' => Yii::t('cherryii/install', 'Frontend toolbar position').' ("top" or "bottom")',
            'visibility' => Setting::VISIBLE_ROOT
        ])->execute();
    }
    ...
    private function installModules()
    {
        ...
        foreach(glob(Yii::getAlias('@cherryii'). DIRECTORY_SEPARATOR .'modules/*') as $module)
        {
            $moduleName = basename($module);
            $moduleClass = 'yii\cherryii\modules\\' . $moduleName . '\\' . ucfirst($moduleName) . 'Module';
