...
class CategoryController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        return $this->render('@cherryii/views/category/index', [
            'cats' => $class::cats()
        ]);
    }
    ...
    public function actionCreate($parent = null)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if(Yii::$app->request->isAjax){
                ...
                if(!$model->hasErrors()){
                    $this->flash('success', Yii::t('cherryii', 'Category created'));
            ...
            return $this->render('@cherryii/views/category/create', [
                'model' => $model,
                'parent' => $parent
            ]);
        }
    ...
    public function actionEdit($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if(Yii::$app->request->isAjax){
                ...
                if($model->save()){
                    $this->flash('success', Yii::t('cherryii', 'Category updated'));
                }
                else{
            ...
            return $this->render('@cherryii/views/category/edit', [
                'model' => $model
            ]);
        }
    }
    ...
    public function actionDelete($id)
    {
        ...
        return $this->formatResponse(Yii::t('cherryii', 'Category deleted'));
    }
    ...
    public function changeStatus($id, $status)
    {
        ...
        return $this->formatResponse(Yii::t('cherryii', 'Status successfully changed'));
    }
}