<?php
namespace yii\cherryii\modules\feedback\api;

use Yii;
use yii\cherryii\modules\feedback\models\Feedback as FeedbackModel;

use yii\helpers\Html;
use yii\helpers\Url;
use yii\widgets\ActiveForm;
use yii\cherryii\widgets\ReCaptcha;


/**
 * Feedback module API
 * @package yii\cherryii\modules\feedback\api
 *
...
class Feedback extends \yii\cherryii\components\API
{
    ...
    public function api_form($options = [])
    {
        ...
        echo Html::submitButton(Yii::t('cherryii', 'Send'), ['class' => 'btn btn-primary']);
        ActiveForm::end();
