...
use yii\cherryii\widgets\TagsInput;
...
<?php if($this->context->module->settings['enableThumb']) : ?>
    <?php if($model->image) : ?>
        ...
        <a href="<?= Url::to(['/admin/'.$module.'/a/clear-image', 'id' => $model->news_id]) ?>" class="text-danger confirm-delete" title="<?= Yii::t('cherryii', 'Clear image')?>"><?= Yii::t('cherryii', 'Clear image')?></a>
    <?php endif; ?>
