<?php
namespace yii\cherryii\modules\subscribe\api;
 ...
 * @package yii\cherryii\modules\subscribe\api
 *
...
class Subscribe extends \yii\cherryii\components\API
{
    ...
    public function api_form($options = [])
    {
        ...
        echo Html::submitButton(Yii::t('cherryii/subscribe/api', 'Subscribe'), ['class' => 'btn btn-primary', 'id' => 'subscriber-send']);
