...
use yii\cherryii\modules\catalog\models\ItemData;
...
/**
 * Catalog module API
 * @package yii\cherryii\modules\catalog\api
 *
...
class Catalog extends \yii\cherryii\components\API
{
    private $_cats;
    private $_items;
    private $_adp;
