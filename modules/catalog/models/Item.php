...
class Item extends \yii\cherryii\components\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'description' => Yii::t('cherryii', 'Description'),
            'available' => Yii::t('cherryii/catalog', 'Available'),
            'price' => Yii::t('cherryii/catalog', 'Price'),
            'discount' => Yii::t('cherryii/catalog', 'Discount'),
