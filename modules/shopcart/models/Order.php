<?php
namespace yii\cherryii\modules\shopcart\models;
...
class Order extends \yii\cherryii\components\ActiveRecord
{
    ...
    const SESSION_KEY = 'cherryii_shopcart_at';

    public static function tableName()
    {
        return 'cherryii_shopcart_orders';
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'email' => Yii::t('cherryii', 'E-mail'),
            'address' => Yii::t('cherryii/shopcart', 'Address'),
            'phone' => Yii::t('cherryii/shopcart', 'Phone'),
            'comment' => Yii::t('cherryii/shopcart', 'Comment'),
            'remark' => Yii::t('cherryii/shopcart', 'Admin remark'),
        ];
    }
    ...
    {
        return [
            self::STATUS_BLANK => Yii::t('cherryii/shopcart', 'Blank'),
            self::STATUS_PENDING => Yii::t('cherryii/shopcart', 'Pending'),
            self::STATUS_PROCESSED => Yii::t('cherryii/shopcart', 'Processed'),
            self::STATUS_DECLINED => Yii::t('cherryii/shopcart', 'Declined'),
            self::STATUS_SENT => Yii::t('cherryii/shopcart', 'Sent'),
            self::STATUS_RETURNED => Yii::t('cherryii/shopcart', 'Returned'),
            self::STATUS_ERROR => Yii::t('cherryii/shopcart', 'Error'),
            self::STATUS_COMPLETED => Yii::t('cherryii/shopcart', 'Completed'),
        ];
    }
