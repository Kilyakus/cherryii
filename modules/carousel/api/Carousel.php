<?php
namespace yii\cherryii\modules\carousel\api;

use Yii;
use yii\cherryii\components\API;
use yii\cherryii\helpers\Data;
use yii\cherryii\modules\carousel\models\Carousel as CarouselModel;
use yii\helpers\Html;
use yii\helpers\Url;

/**
 * Carousel module API
 * @package yii\cherryii\modules\carousel\api
...
class Carousel extends API
{
    ...
    public function api_widget($width, $height, $clientOptions = [])
    {
        if(!count($this->_items)){
            return LIVE_EDIT ? Html::a(Yii::t('cherryii/carousel/api', 'Create carousel'), ['/admin/carousel/a/create'], ['target' => '_blank']) : '';
        }
