<?php
namespace yii\cherryii\modules\carousel\controllers;
...
class AController extends Controller
{
            ...
            if(Yii::$app->request->isAjax){
                ...
                if(($fileInstanse = UploadedFile::getInstance($model, 'image')))
                {
                    ...
                    if($model->validate(['image'])){
                        ...
                        if($model->save()){
                            $this->flash('success', Yii::t('cherryii/carousel', 'Carousel created'));
    ...
    public function actionEdit($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if(Yii::$app->request->isAjax){
                ...
                if($model->save()){
                    $this->flash('success', Yii::t('cherryii/carousel', 'Carousel updated'));
                }
                else{
                    $this->flash('error', Yii::t('cherryii/carousel','Update error. {0}', $model->formatErrors()));
                }
                return $this->refresh();
            }
        }
    ...
    public function actionDelete($id)
    {
        ...
        return $this->formatResponse(Yii::t('cherryii/carousel', 'Carousel item deleted'));
    }
