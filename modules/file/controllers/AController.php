...
use yii\cherryii\helpers\Upload;
...
class AController extends Controller
{
            ...
            if(Yii::$app->request->isAjax){
                ...
                if(($fileInstanse = UploadedFile::getInstance($model, 'file')))
                {
                    ...
                    if($model->validate(['file'])){
                        ...
                        if($model->save()){
                            $this->flash('success', Yii::t('cherryii/file', 'File created'));
                        ...
                        $this->flash('error', Yii::t('cherryii/file', 'File error. {0}', $model->formatErrors()));
                    }
                }
                else {
    ...
    public function actionEdit($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if(Yii::$app->request->isAjax){
                ...
                if($model->save()){
                    $this->flash('success', Yii::t('cherryii/file', 'File updated'));
                }
                else {
    ...
    public function actionDelete($id)
    {
        ...
        return $this->formatResponse(Yii::t('cherryii/file', 'File deleted'));
    }
